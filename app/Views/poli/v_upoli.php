        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <!-- /.card-header -->
                    <div class="card-body">
                            <form action="<?= base_url(); ?>/Poli/upoliAksi" method="POST">
                            <div class="form-group">
                                <label>Nama Poli</label>
                                <input type="text" name="poli" class="form-control" value="<?= $data['nm_poli']; ?>" required>
                                <input type="hidden" name="id_poli" value="<?= $data['id_poli']; ?>">
                            </div>
                            <div class="form-group">
                                <label>Deskripsi</label>
                                <textarea name="deskripsi" cols="30" rows="10" class="form-control" required><?= $data['desk_poli']; ?></textarea>
                            </div>
                        </div>
