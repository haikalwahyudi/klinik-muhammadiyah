...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Data Konsultasi Dokter</h1>
                </div><!-- /.col -->
                <!-- <div class="col-sm-6">
            ...
            ?>
                <div class="row">
                    ...
                    foreach ($data as $d) {
                        ...
                        $dt = $db->query("SELECT * FROM user WHERE id_user = '$d[tujuan]'")->getRowArray();
                    ?>
                        <div class="col-md-3">
                            <div class="card card-success card-outline">
                                <div class="card-body box-profile">
                                    ...
                                    <a href="<?= base_url() ?>/Chat/chat/<?= $d['tujuan'] ?>" class="btn btn-success btn-block"><b>Buka</b></a>
                                </div>
                                <!-- /.card-body -->
                            </div>
                        </div>
