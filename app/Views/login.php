...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>/uilogin/font-awesome/css/font-awesome.min.css" />
    <!-- Google web Font -->
    <link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Montserrat:400,500">
    <!-- Bootstrap core CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>/uilogin/css/bootstrap.min.css">
    <!-- Material Design Lite Stylesheet CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>/uilogin/css/material.min.css" />
    <!-- Material Design Select Field Stylesheet CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>/uilogin/css/mdl-selectfield.min.css">
    <!-- Owl Carousel Stylesheet CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>/uilogin/css/owl.carousel.min.css" />
    <!-- Animate Stylesheet CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>/uilogin/css/animate.min.css" />
    <!-- Magnific Popup Stylesheet CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>/uilogin/css/magnific-popup.css" />
    <!-- Flex Slider Stylesheet CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>/uilogin/css/flexslider.css" />
    <!-- Custom Main Stylesheet CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>/uilogin/css/style.css">
</head>
...
<body>
    ...
    <script src="<?= base_url() ?>/uilogin/js/jquery-2.1.4.min.js"></script>
    <!-- Popper JavaScript-->
    <script src="<?= base_url() ?>/uilogin/js/popper.min.js"></script>
    <!-- Bootstrap Core JavaScript-->
    <script src="<?= base_url() ?>/uilogin/js/bootstrap.min.js"></script>
    <!-- Material Design Lite JavaScript-->
    <script src="<?= base_url() ?>/uilogin/js/material.min.js"></script>
    <!-- Material Select Field Script -->
    <script src="<?= base_url() ?>/uilogin/js/mdl-selectfield.min.js"></script>
    <!-- Flexslider Plugin JavaScript-->
    <script src="<?= base_url() ?>/uilogin/js/jquery.flexslider.min.js"></script>
    <!-- Owl Carousel Plugin JavaScript-->
    <script src="<?= base_url() ?>/uilogin/js/owl.carousel.min.js"></script>
    <!-- Scrolltofixed Plugin JavaScript-->
    <script src="<?= base_url() ?>/uilogin/js/jquery-scrolltofixed.min.js"></script>
    <!-- Magnific Popup Plugin JavaScript-->
    <script src="<?= base_url() ?>/uilogin/js/jquery.magnific-popup.min.js"></script>
    <!-- WayPoint Plugin JavaScript-->
    <script src="<?= base_url() ?>/uilogin/js/jquery.waypoints.min.js"></script>
    <!-- CounterUp Plugin JavaScript-->
    <script src="<?= base_url() ?>/uilogin/js/jquery.counterup.js"></script>
    <!-- SmoothScroll Plugin JavaScript-->
    <script src="<?= base_url() ?>/uilogin/js/smoothscroll.min.js"></script>
    <!--Custom JavaScript for Klinik Template-->
    <script src="<?= base_url() ?>/uilogin/js/custom.js"></script>
</body>
